...
That count is not a ratchet: positive evidence that the pane itself moved returns it to zero, while elapsed time never does, and [`watcher-continuity.md`](watcher-continuity.md#one-alarm-reset-rule-two-applications) owns that reset rule.
